...
public class SimpleTest1 {
	...
	public static void main(String[] args) throws Exception {
		...
		ProcessingReport report = validator.validate(instance1, t).getRawProcessingReport();
		...
		ProcessingReport report2 = validator.validate(instance1RootNode, t).getRawProcessingReport();
