...
public class WorkspaceClient {
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public Tuple7<Long, String, String, String, Long, String, String> renameWorkspace(RenameWorkspaceParams params) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<Tuple7<Long, String, String, String, Long, String, String>>> retType = new TypeReference<List<Tuple7<Long, String, String, String, Long, String, String>>>() {};
        List<Tuple7<Long, String, String, String, Long, String, String>> res = caller.jsonrpcCall("Workspace.rename_workspace", args, retType, true, true);
        return res.get(0);
    }
