...
public class WorkspaceServer extends JsonServerServlet {
    ...
    public Tuple7<Long, String, String, String, Long, String, String> renameWorkspace(RenameWorkspaceParams params, AuthToken authPart) throws Exception {
        Tuple7<Long, String, String, String, Long, String, String> returnVal = null;
        //BEGIN rename_workspace
		checkAddlArgs(params.getAdditionalProperties(), params.getClass());
		final WorkspaceIdentifier wsi = processWorkspaceIdentifier(params.getWs());
