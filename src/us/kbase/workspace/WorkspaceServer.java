...
public class WorkspaceServer extends JsonServerServlet {
    ...
    public Tuple6<Long, String, String, String, String, String> getWorkspaceInfo(WorkspaceIdentity wsi, AuthToken authPart) throws Exception {
        Tuple6<Long, String, String, String, String, String> returnVal = null;
...
//		final WorkspaceObjectCollection woc = new WorkspaceObjectCollection(wsi);
    ...
    public List<Tuple10<Long, String, String, String, Long, String, Long, String, Long, Map<String,String>>> getObjectInfo(List<ObjectIdentity> objectIds, AuthToken authPart) throws Exception {
