...
/**
 * <p>Original spec-file type: ListObjectsParameters</p>
 * <pre>
...
public class ListObjectsParameters {
    ...
    public ListObjectsParameters withWorkspaces(List<String> workspaces) {
        this.workspaces = workspaces;
        return this;
    }
    ...
    public ListObjectsParameters withIds(List<Long> ids) {
        this.ids = ids;
        return this;
    }
    ...
    public ListObjectsParameters withType(java.lang.String type) {
        this.type = type;
        return this;
    }
    ...
    public ListObjectsParameters withShowDeleted(java.lang.Long showDeleted) {
        this.showDeleted = showDeleted;
        return this;
    }
    ...
    public ListObjectsParameters withShowHidden(java.lang.Long showHidden) {
        this.showHidden = showHidden;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((("ListObjectsParameters"+" [workspaces=")+ workspaces)+", ids=")+ ids)+", type=")+ type)+", showDeleted=")+ showDeleted)+", showHidden=")+ showHidden)+", additionalProperties=")+ additionalProperties)+"]");
    }
