...
public class FakeObjectInfo implements ObjectInformation {
	...
	public String toString() {
		return "FakeObjectInfo [id=" + id + ", name=" + name + ", type=" + type
				+ ", savedDate=" + savedDate + ", version=" + version
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FakeObjectInfo other = (FakeObjectInfo) obj;
		if (chksum == null) {
