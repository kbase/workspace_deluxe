...
function Workspace(url, auth, auth_cb) {
    ...
    this.grant_module_ownership = function (module_name, new_owner, with_grant_option, _callback, _errorCallback) {
    return json_call_ajax("Workspace.grant_module_ownership",
        [module_name, new_owner, with_grant_option], 0, _callback, _errorCallback);
};

    this.grant_module_ownership_async = function (module_name, new_owner, with_grant_option, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.grant_module_ownership", [module_name, new_owner, with_grant_option], 0, _callback, _error_callback);
    };

    this.remove_module_ownership = function (module_name, old_owner, _callback, _errorCallback) {
    return json_call_ajax("Workspace.remove_module_ownership",
        [module_name, old_owner], 0, _callback, _errorCallback);
};

    this.remove_module_ownership_async = function (module_name, old_owner, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.remove_module_ownership", [module_name, old_owner], 0, _callback, _error_callback);
    };
