...
function Workspace(url, auth, auth_cb) {
    ...
    this.register_typespec_copy = function (external_workspace_url, mod, version_in_external_workspace, _callback, _errorCallback) {
    ...
    this.register_typespec_copy_async = function (external_workspace_url, mod, version_in_external_workspace, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.register_typespec_copy", [external_workspace_url, mod, version_in_external_workspace], 1, _callback, _error_callback);
    };
