...
function Workspace(url, auth, auth_cb) {
    ...
    this.get_object_metadata = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_object_metadata",
        [object_ids], 1, _callback, _errorCallback);
};

    this.get_object_metadata_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_object_metadata", [object_ids], 1, _callback, _error_callback);
    };
    ...
    this.release_types = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.release_types",
        [params], 1, _callback, _errorCallback);
};

    this.release_types_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.release_types", [params], 1, _callback, _error_callback);
    };

    this.list_modules = function (_callback, _errorCallback) {
    return json_call_ajax("Workspace.list_modules",
        [], 1, _callback, _errorCallback);
};

    this.list_modules_async = function (_callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_modules", [], 1, _callback, _error_callback);
    };

    this.get_typespec = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_typespec",
        [params], 1, _callback, _errorCallback);
};

    this.get_typespec_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_typespec", [params], 1, _callback, _error_callback);
    };
