...
function Workspace(url, auth, auth_cb) {
    ...
    this.list_workspace_info = function (_callback, _errorCallback) {
    return json_call_ajax("Workspace.list_workspace_info",
        [], 1, _callback, _errorCallback);
};

    this.list_workspace_info_async = function (_callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_workspace_info", [], 1, _callback, _error_callback);
    };

    this.list_objects = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_objects",
        [wsi], 1, _callback, _errorCallback);
};

    this.list_objects_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_objects", [wsi], 1, _callback, _error_callback);
    };
