...
function Workspace(url, auth, auth_cb) {
    ...
    this.get_object_metadata = function (objects, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_object_metadata",
        [objects], 1, _callback, _errorCallback);
};

    this.get_object_metadata_async = function (objects, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_object_metadata", [objects], 1, _callback, _error_callback);
    };

    this.delete_objects = function (objects, _callback, _errorCallback) {
    return json_call_ajax("Workspace.delete_objects",
        [objects], 0, _callback, _errorCallback);
};

    this.delete_objects_async = function (objects, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.delete_objects", [objects], 0, _callback, _error_callback);
    };

    this.undelete_objects = function (objects, _callback, _errorCallback) {
    return json_call_ajax("Workspace.undelete_objects",
        [objects], 0, _callback, _errorCallback);
};

    this.undelete_objects_async = function (objects, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.undelete_objects", [objects], 0, _callback, _error_callback);
    };
