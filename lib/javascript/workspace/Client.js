...
function Workspace(url, auth, auth_cb) {
    ...
    this.get_func_info = function (type, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_func_info",
        [type], 1, _callback, _errorCallback);
};

    this.get_func_info_async = function (type, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_func_info", [type], 1, _callback, _error_callback);
    };
