...
function Workspace(url, auth, auth_cb) {
    ...
    this.rename_objects = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.rename_objects",
        [params], 1, _callback, _errorCallback);
};

    this.rename_objects_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.rename_objects", [params], 1, _callback, _error_callback);
    };
